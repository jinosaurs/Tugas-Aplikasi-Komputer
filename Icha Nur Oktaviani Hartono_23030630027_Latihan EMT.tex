...
\begin{eulercomment}
\begin{eulercomment}
\eulerheading{Menyisipkan baris perintah (1)}
\begin{eulerprompt}
>plot2d("sin(x)*exp(-x^2)",-pi,pi,title="Test",xl="x",yl="y"):
\end{eulerprompt}
\eulerimg{27}{images/Icha Nur Oktaviani Hartono_23030630027_Latihan EMT-001.png}
\begin{eulercomment}
...
\end{eulercomment}
\eulersubheading{Menyisipkan baris perintah (2)}
\eulersubheading{}
\begin{eulerprompt}
>sin(45°)
\end{eulerprompt}
...
2. Carilah turunan kedua dari y=x\textasciicircum{}3+3*x\textasciicircum{}2-2*x-8.
\end{eulercomment}
\begin{eulerprompt}
...
\eulerheading{Soal Latihan }
\begin{eulercomment}
1. Carilah akar-akar dari persamaan kuadrat x\textasciicircum{}2+8x+12=0.
\end{eulercomment}
\begin{eulerprompt}
>$&solve(x^2+8*x+12,x)
\end{eulerprompt}
...
parabool-parabol y=x\textasciicircum{}2 dan y\textasciicircum{}2=8x diputar mengelilingi sumbu x.
\end{eulercomment}
\begin{eulerprompt}
...
nilai rata-rata 600 dan simpangan baku (3600*(1/6)*(5/6))\textasciicircum{}1/2.
